...
@interface AnimationControl ()<AnimationViewDelegate>

@property (nonatomic, strong) AnimationView *narrowView;
@property (nonatomic, strong) AnimationView *opNarrowView;
...
#pragma mark AnimtionViewDelegate
...
- (AnimationView *)narrowView
{
    if (!_narrowView) {
        _narrowView = [[AnimationView alloc]initWithFrame:CGRectMake(0, 0, self.frame.size.width, self.frame.size.height)];
...
- (AnimationView *)opNarrowView
{
    if (!_opNarrowView) {
        _opNarrowView = [[AnimationView alloc]initWithFrame:CGRectMake(0, 0, self.frame.size.width, self.frame.size.height)];
